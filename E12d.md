...
prepared by Henrik Fisser within the [upscaling part](https://eo4society.esa.int/2020/04/24/from-the-covid-19-custom-script-contest-to-the-euro-data-cube-european-dashboard/) of the [COVID-19 Custom Script Contest](https://www.sentinel-hub.com/contest-covid/) of [EuroDataCube](https://eurodatacube.com/).
...
Since the station data is hourly, its mean per 15 minutes was calculated for the date and time of the respective Sentinel-2 acquisition. Yet, the validation is limited to Germany. Furthermore, it has to be noted that an area-specific uncertainty is introduced by potential haze. 
<p align="center">
