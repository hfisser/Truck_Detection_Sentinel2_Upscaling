...
### Overall results
In average 15 % less trucks were observed on motorways in the European Union during the considered period. However, the figures vary across the EU as depicted in Fig. 2. The picture might already suggest some patterns, however it is worth to look into the details. 
<p align="center">
